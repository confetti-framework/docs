...
- [Introduction](#introduction)
  - [Writing The Validation Logic](#writing_the_validation_logic)
    - [Nested Attributes](#nested_attributes)
  - [Displaying The Validation Errors](#displaying_the_validation_errors)
    - [Return Errors As Response](#return_errors_as_response)
    - [Use Errors In Views](#use_errors_in_views)
    - [Fetch Error By Field](#fetch_error_by_field)
