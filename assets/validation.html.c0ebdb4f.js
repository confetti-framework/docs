import{_ as n,o as s,c as a,b as t}from"./app.d05353ee.js";const e={},p=t(`<h1 id="validation" tabindex="-1"><a class="header-anchor" href="#validation" aria-hidden="true">#</a> Validation</h1><h2 id="introduction" tabindex="-1"><a class="header-anchor" href="#introduction" aria-hidden="true">#</a> Introduction</h2><p>Good validation prevents bugs and enhances the security of your application. In this guide, we demonstrate how to validate incoming data in a Go application without using external libraries.</p><h2 id="writing-the-validation-logic" tabindex="-1"><a class="header-anchor" href="#writing-the-validation-logic" aria-hidden="true">#</a> Writing the Validation Logic</h2><p>In this example, we validate the <code>CreateUser</code> request. The <code>ValidateCreateUser</code> function will handle the validation logic separately from the controller.</p><div class="language-go ext-go line-numbers-mode"><pre class="language-go"><code><span class="token keyword">package</span> user
